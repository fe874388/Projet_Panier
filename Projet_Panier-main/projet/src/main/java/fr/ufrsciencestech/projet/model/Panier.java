...
public class Panier {
    ...
    public void setFruits(ArrayList<Fruit> fruit) { //modificateur du premier attribut
      this.fruits = fruit;
    }
    ...
    public void ajout(Fruit o) throws PanierPleinException{  //ajoute le fruit o a la fin du panier si celui-ci n'est pas plein
        if (fruits.size() < contenanceMax) {
        fruits.add(o);
        pcs.fireIndexedPropertyChange("fruits", fruits.size(), null, o);
       }
       else
        throw new PanierPleinException();
    }
    ...
    public void retrait() throws PanierVideException{ //retire le dernier fruit du panier si celui-ci n'est pas vide
        if(!fruits.isEmpty()){
            ...
            pcs.fireIndexedPropertyChange("remove", removedIndex, this.getFruit(removedIndex), null);
        } else{
