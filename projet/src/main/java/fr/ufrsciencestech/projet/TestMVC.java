...
public class TestMVC {
    ...
    public static void main (String[] args){
        //tests pour le design pattern fabrique
        Panier panier = new Panier(10);
        
        FruitFactory orangeFac = new OrangeFactory();
        FruitFactory kiwiFac = new KiwiFactory();
        FruitFactory fraiseFac = new FraiseFactory();
        CeriseFactory ceriseFac = new CeriseFactory();

        Fruit orange = orangeFac.creerFruit();
        Fruit kiwi = kiwiFac.creerFruit();
        Fruit fraise = fraiseFac.creerFruit(50, "algérie");
        Fruit cerise = ceriseFac.creerFruit(60, "");
        
        System.out.println(orange.toString()+"\n"+kiwi.toString()+"\n"+fraise.toString()+"\n"+cerise.toString());
        
        
        //----------------------------- partie graphique (JFRAME)------------------------------//
